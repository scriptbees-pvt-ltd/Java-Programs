...
public class AreaUsingTrapezoidalsRule 
{
	public static void main(String[] args) 
	{
		/*Let's declare the values according to Trapezoidal's Rule;
		 ...
		 */
		double a,b,n,h,x,y,sum1,sum2=0,area;
		...
		for(int count=0;count<=n;count++)
		{
			yArray[count] = Math.sqrt(1+(array[count]*array[count]));  
			System.out.print(yArray[count]+" ");
		}
		
		//Calculating the area using Trapezoidals Rule;
		...
		area = (h*(sum1+(2*sum2)))/2;
		
		System.out.println("\n\n"+"The area for the given function ∫√1+x^2*dx is: "+"\n"+"Area≈ "+area);
	}
}
